...
vehicles: List[Vehicle] = [
    Vehicle(
        ...
        available_trims=[
            TrimOption(trim="LE", price=30000, msrp=30000,
                       drivetrain="FWD", mpg_city=28, mpg_highway=39),
            TrimOption(trim="SE", price=33000, msrp=33000,
                       drivetrain="FWD", mpg_city=28, mpg_highway=39),
            TrimOption(trim="XLE", price=34700, msrp=34700,
                       drivetrain="FWD", mpg_city=26, mpg_highway=37),
            # Hybrid trim (marking Camry as hybrid-available)
    ...
    Vehicle(
        ...
        image="assets/highlanderhybrid.png",
        available_trims=[
            TrimOption(trim="L", price=54349, msrp=54349,
                       drivetrain="FWD", mpg_city=21, mpg_highway=29, is_hybrid=True),
            TrimOption(trim="LE", price=45000, msrp=45000,
                       drivetrain="AWD", mpg_city=21, mpg_highway=28),
            TrimOption(trim="XLE", price=50367, msrp=50367,
                       drivetrain="AWD", mpg_city=21, mpg_highway=28),
            TrimOption(trim="Limited", price=52000, msrp=52000,
                       drivetrain="AWD", mpg_city=20, mpg_highway=27),
            TrimOption(trim="Platinum", price=58829, msrp=58829,
                       drivetrain="AWD", mpg_city=20, mpg_highway=27),
        ],
        reviews=[
    ...
    Vehicle(
        ...
        available_trims=[
            TrimOption(trim="LE", price=32000, msrp=32000,
                       drivetrain="FWD", mpg_city=27, mpg_highway=35, is_hybrid=True),
    ...
    Vehicle(
        ...
        carfax_rating=4.7,
        kelly_blue_rating=4.5,
        image="/assets/rav4plugin.png",
        available_trims=[
            TrimOption(trim="SE", price=42900, msrp=42900,
                       drivetrain="FWD", mpg_city=38, mpg_highway=35, is_hybrid=True),
            TrimOption(trim="XSE", price=45900, msrp=45900,
                       drivetrain="AWD", mpg_city=36, mpg_highway=34, is_hybrid=True),
        ],
        reviews=[]
    ),
    Vehicle(
        ...
        available_trims=[
            ...
            TrimOption(trim="LE", price=44000, msrp=44000,
            ...
            TrimOption(trim="XSE", price=55000, msrp=55000,
                       drivetrain="AWD", mpg_city=35, mpg_highway=35, is_hybrid=True),
            TrimOption(trim="Limited", price=58000, msrp=58000,
                       drivetrain="AWD", mpg_city=35, mpg_highway=35, is_hybrid=True),
            TrimOption(trim="Platinum", price=62000, msrp=62000,
                       drivetrain="AWD", mpg_city=35, mpg_highway=35, is_hybrid=True),
        ],
        reviews=[
    ...
    Vehicle(
        ...
        available_trims=[
            TrimOption(trim="SR5", price=44000, msrp=44000,
                       drivetrain="4WD", mpg_city=16, mpg_highway=19, is_hybrid=True),
    ...
    Vehicle(
        ...
        carfax_rating=4.7,
        kelly_blue_rating=4.5,
        image="assets/tacoma.png",
        available_trims=[
            TrimOption(trim="SR", price=31000, msrp=31000,
                       drivetrain="4WD", mpg_city=20, mpg_highway=23, is_hybrid=True),
    ...
    Vehicle(
        ...
        carfax_rating=4.7,
        kelly_blue_rating=4.6,
        image="/assets/sequoia.png",
        available_trims=[
            TrimOption(trim="TRD Pro", price=85370, msrp=85370,
                       drivetrain="4WD", mpg_city=19, mpg_highway=22, is_hybrid=True),
            TrimOption(trim="Limited", price=65000, msrp=65000,
                       drivetrain="4WD", mpg_city=19, mpg_highway=22),
            TrimOption(trim="Platinum", price=85829, msrp=85829,
                       drivetrain="4WD", mpg_city=18, mpg_highway=21),
            TrimOption(trim="Capstone", price=82000, msrp=82000,
                       drivetrain="4WD", mpg_city=18, mpg_highway=21),
        ],
        reviews=[]
    ),
    Vehicle(
        ...
        available_trims=[
            TrimOption(trim="XLE", price=38000, msrp=38000,
                       drivetrain="FWD", mpg_city=22, mpg_highway=31, is_hybrid=True),
