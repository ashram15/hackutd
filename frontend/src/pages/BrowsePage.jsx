...
export default function BrowsePage() {
    ...
    // Find selected car for modal view
                        ...
                        {cars.map((car) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    ...
                                    <button onClick={() => setSelectedCar(car.id)} className="w-full mt-4 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
                                        View Details
                                    </button>
                                </div>
                            </div>
